...
class Contenedor {
    ...
    async save(object) {
        ...
        try {
            ...
            if (err.code === 'ENOENT') {
                ...
                console.log('Error en método Guardar: ', err);
            }
        }
    }
    ...
    async getById(number) {
        ...
        try {
            ...
            console.log('Error en método Mostar: ', err);
        }
    }
    ...
    async getAll() {
        ...
        try {
            ...
            if (err.code === 'ENOENT') {
                ...
                console.log('Error en método Mostrar todos: ', err);
            }
        }
    }
    ...
    async deleteById(number) {
        ...
        try {
            ...
            console.log('Error en método eliminar id: ', err);
        }
    }
    ...
    async deleteAll() {
        ...
        try {
            ...
            console.log('Error en método eliminar todos: ', err);
        }
    }
    ...
    async updateById(id, object) {
        ...
        try {
            ...
            if (index !== -1) {
                ...
                return { error: 'Producto no fue encontrado' }
            }
        } catch (err) {
            console.log('Error en método Actualizar: ', err);
        }
    }
}
